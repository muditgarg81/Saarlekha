...
exports.productionRouter.use(auth_1.authenticate);
// List production records (with optional date filtering for efficiency calculation)
exports.productionRouter.get('/', async (req, res) => {
...
exports.productionRouter.post('/', async (req, res) => {
    const tenantId = req.tenantId;
    const data = req.body;
    const prismaTenant = (0, prisma_1.getTenantPrisma)(tenantId);
    try {
...
exports.productionRouter.delete('/:id', async (req, res) => {
    const tenantId = req.tenantId;
    const { id } = req.params;
    const prismaTenant = (0, prisma_1.getTenantPrisma)(tenantId);
    try {
...
exports.productionRouter.post('/bulk-delete', async (req, res) => {
    const tenantId = req.tenantId;
    const { ids } = req.body;
    const prismaTenant = (0, prisma_1.getTenantPrisma)(tenantId);
