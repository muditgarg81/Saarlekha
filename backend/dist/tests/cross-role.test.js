...
async function runCrossRoleTests() {
    ...
    try {
        ...
        // Sign JWT tokens
        const adminTokenA = jsonwebtoken_1.default.sign({ id: adminUserA.id, role: adminUserA.role, companyId: adminUserA.company_id }, JWT_SECRET);
        const opsTokenA = jsonwebtoken_1.default.sign({ id: opsUserA.id, role: opsUserA.role, companyId: opsUserA.company_id }, JWT_SECRET);
        const badSecretToken = jsonwebtoken_1.default.sign({ id: opsUserA.id, role: opsUserA.role, companyId: opsUserA.company_id }, 'definitely_wrong_secret_key_12345');
