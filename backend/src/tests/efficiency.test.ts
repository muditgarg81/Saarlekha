...
function runTests() {
  ...
  {
    const res = calculateEfficiency(80, 100);
    if (res === '80.0') {
  ...
  {
    const res = calculateEfficiency(125, 100);
    if (res === '125.0') {
  ...
  {
    const res = calculateEfficiency(50, 0);
    if (res === 'N/A') {
  ...
  {
    const res = calculateEfficiency(50, -10);
    if (res === 'N/A') {
  ...
  {
    const res = calculateEfficiency(1, 3);
    if (res === '33.3') {
