...
export function ProductionDetail() {
  ...
  }, [startDate, endDate, formats, selectedFormatId, selectedDepartmentId]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button 
            onClick={() => navigate(`/data-entry?type=PRODUCTION&returnUrl=${returnUrl}`)} 
            ...
            <div className="p-4 space-y-4">
              {sortedEntries.map(entry => {
                ...
                return (
                  ...
                  >
                    {/* Header: Date, Select checkbox, Dropdown actions */}
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs pt-1">
                      ...
                      {/* Efficiency */}
                      <div className="bg-surface/40 p-2 rounded border border-border/40 col-span-2 flex justify-between items-center">
                        <span className="text-[10px] text-text-secondary uppercase font-semibold">Row Efficiency</span>
                        <EfficiencyBadge value={eff} />
                      </div>
                    </div>
                  </div>
